...
export function ThemeToggleModern() {
  ...
  if (!mounted) {
    return (
      <button className="p-2 rounded-lg bg-muted/50 hover:bg-muted/70 transition-colors">
  ...
  return (
    <button
      onClick={toggleTheme}
      className="p-2 rounded-lg bg-muted/50 hover:bg-muted/70 transition-all duration-200 group focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background"
