            ...
            <div className="flex items-center gap-6">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className="text-green-600 dark:text-green-400 font-medium">{meme.wins} 胜</span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <span className="text-red-500">●</span>
                  <span className="text-red-600 dark:text-red-400 font-medium">{meme.losses} 负</span>
                </div>
              </div>
